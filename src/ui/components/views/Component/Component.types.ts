 ...
 * @name phase
 *
 * @description One of several mutually exclusive states that the entire component can be in.
 */
 ...
 * @name State
 *
 * @description These are (interactive/changeable) values provided by this component's
 * primary hook.
 *
